        ...
        <div className="flex-1">
          ...
          <div className="mt-8">
            ...
            <div className="flex justify-between py-4 border-t border-gray-200 mt-2">
              ...
              <span className="text-xl font-bold text-[#d90429]">1.544.000 đ</span>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div 
                  className={`border rounded ${paymentMethod === 'cod' ? 'bg-gray-700 text-white' : 'bg-gray-200'} p-4 flex flex-col items-center justify-center cursor-pointer`}
                ...
                <div 
                  className={`border rounded ${paymentMethod === 'direct' ? 'bg-gray-700 text-white' : 'bg-gray-200'} p-4 flex flex-col items-center justify-center cursor-pointer`}
              ...
              <div className="border rounded p-4 mt-6">
                ...
                {paymentMethod === 'cod' ? (
                  ...
                  <p className="text-gray-700">Quý khách vui lòng chuyển khoản theo thông tin tài khoản sẽ được cung cấp sau khi đặt hàng.</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col items-start">
            ...
            >
              Thanh toán 1.544.000 đ ({paymentMethod === 'cod' ? 'CoD' : 'Chuyển khoản'})
            </button>
          </div>
        </div>
